...
> Add alan.local to /etc/hosts

Run 3 nodes

```sh
NODE_NAME=node1 HTTP_PORT=8081 ALAN_BIND_ADDR=127.0.1.1 REPLICAS=3 go run ./example/cluster
NODE_NAME=node2 HTTP_PORT=8082 ALAN_BIND_ADDR=127.0.1.2 REPLICAS=3 go run ./example/cluster
NODE_NAME=node3 HTTP_PORT=8083 ALAN_BIND_ADDR=127.0.1.3 REPLICAS=3 go run ./example/cluster
```
